...
public class Main {
  ...
  price2=sc.nextInt();
  System.out.println("ادخل السعر");
 System.out.println("الاجمالي"+(price2*NumberofAmount2));
  Item3=sc.next();
  ...
  price3=sc.nextInt();
  System.out.println("ادخل السعر");
 System.out.println("الاجمالي"+(price3*NumberofAmount3));
...
(price2*NumberofAmount2+price1*NumberofAmount1);
 ...
 else (price1*NumberofAmount1+price2*NumberofAmount2+price3*NumberofAmount3);
